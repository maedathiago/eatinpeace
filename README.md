...
Eat in Peace é um produto de orquestração de atendimento para restaurantes, criado para reduzir filas invisíveis, pedidos esquecidos e ansiedade do cliente durante o serviço de salão.

A tese inicial e a definição dos agentes estão em:
